...
export default function Submission({ submission }) {
  ...
  return (
    <Layout>
      ...
      <article className="bg-white p-5 shadow-md rounded-md">
        <header className="bg-white pb-5">
          <div className="flex justify-between items-start flex-wrap sm:flex-nowrap">
            ...
            {submission.file && (
              <div className="mt-4 sm:mt-1 sm:ml-4 flex-shrink-0 flex">
                <a href={`/downloads/posters/${submission.file}`} download
        ...
        <div className="video" dangerouslySetInnerHTML={{__html: submission.embed}} />
      </article>
